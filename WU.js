...
function guessCurrentCondition(observation) {
    ...
    if (precipRate > 0) {
    ...
    } else if (solarRadiation > 80 && uvIndex > 0 && humidity < 75) {
        condition = "☀️ Sunny";
    } else if (windSpeed > 1) {
        condition = "💨 Breezy";
    } else if (windSpeed > 5) {
        ...
        condition = "🌃 Night";
    } else if (humidity > 77 && solarRadiation >= 75 && solarRadiation < 161) {
        condition = "🌤️ Hazy";
    } else if (humidity > 89 && solarRadiation >= 1 && solarRadiation < 75) {
